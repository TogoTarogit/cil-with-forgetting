...
# EWC　の差分行列をプロット
plt.figure(figsize=(10, 10))
plt.imshow(matrix_diff, cmap='RdBu', interpolation='nearest',vmin=vmin_manual, vmax=vmax_manual)
...
plt.figure(figsize=(10, 10))
img = plt.imshow(matrix_diff, cmap='RdBu', interpolation='nearest', vmin=vmin_manual, vmax=vmax_manual)
# plt.colorbar()
...
# 差分行列をプロット
plt.figure(figsize=(10, 10))
plt.imshow(matrix_diff_finetuning, cmap='RdBu', interpolation='nearest', vmin=vmin_manual, vmax=vmax_manual)
